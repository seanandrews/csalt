...
# I/O
datafile = 'storage/data/fiducial_hires/fiducial_hires_pure_naif_natv.DATA'
post_dir = 'storage/posteriors/naif/'
postfile = 'fiducial_hires_pure_naif_natv.h5'
...
run_emcee(datafile, fixed, vra=vra_fit, vcensor=vcensor, nwalk=nwalk, chbin=1,

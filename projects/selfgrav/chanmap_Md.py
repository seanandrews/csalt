...
# cube files
cdir = '/pool/asha0/SCIENCE/csalt/storage/radmc/'
cfiles = [cdir+'sg_taper2hi_M05/raw_cube.fits',
          cdir+'sg_taper2hi/raw_cube.fits',
          cdir+'sg_taper2hi_M15/raw_cube.fits']
clbls = ['0.05 $M_\\odot$', '0.10 $M_\\odot$', '0.15 $M_\\odot$']
...
fig.savefig('figs/chanmap_Md.pdf')
fig.clf()

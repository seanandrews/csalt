...
# cube files
sharpcdir = '/pool/asha0/SCIENCE/csalt/storage/radmc/sg_sharpchi/'
taper1dir = '/pool/asha0/SCIENCE/csalt/storage/radmc/sg_taper1hi/'
taper2dir = '/pool/asha0/SCIENCE/csalt/storage/radmc/sg_taper2hi/'
taper3dir = '/pool/asha0/SCIENCE/csalt/storage/radmc/sg_taper3hi/'
cfiles = [sharpcdir+'raw_cube.fits',
          taper1dir+'raw_cube.fits',
          taper2dir+'raw_cube.fits',
          taper3dir+'raw_cube.fits']
clbls = ['$\mathsf{sharp c}$', '$\mathsf{taper 1}$', 
         '$\mathsf{taper 2}$', '$\mathsf{taper 3}$']
...
fig.savefig('figs/chanmap_models.pdf')
fig.clf()
